// Finalized Navigation.tsx - Glassmorphic mobile menu with animation and swipe-to-close
  ...
  return (
    <nav className="fixed top-0 left-0 w-full z-50 backdrop-blur-md bg-white/10 border-b border-white/10 shadow-sm">
      ...
      >
        <div
          ref={panelRef}
          className={`w-[90%] pointer-events-auto shadow-card border border-white/20 rounded-xl mt-2 p-4 space-y-2 transform transition-all duration-500 ease-out bg-white/20 backdrop-blur-md backdrop-saturate-150 ${
