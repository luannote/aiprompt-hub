// Updated Navigation.tsx - mobile menu now fully mimics the glassmorphic effect of the top navbar
      ...
      <div className="container mx-auto px-4">
        ...
        {isOpen && (
          <div className="md:hidden relative z-50 mt-2">
            ...
            <div className="fixed inset-0 bg-white/10 backdrop-blur-md z-40" onClick={() => setIsOpen(false)} />

            {/* Floating menu */}
            <div className="relative z-50 px-4 pt-4 pb-6 space-y-2 rounded-xl mx-4 mt-4 shadow-card border border-white/20 bg-white/30 backdrop-blur-md">
              {navItems.map((item) => (
                <Link
                  key={item.name}
                  to={item.path}
